...
const questions = [
  {
    id: 1,
    question: "당신은 숲을 지나가다 외진 길에 주차된 차 한 대를 찾았습니다.",
    answers: [
  ...
  {
    id: 3,
    question: "당신은 2층 건물의 2층을 수색 중이었습니다.",
    answers: [
  ...
  {
    id: 4,
    question: "당신은 한적한 도시 근교를 지나가던 중이었습니다.",
    answers: [
  ...
  {
    id: 5,
    question: "당신은 상당히 우호적인 생존자들을 조우했습니다.",
    answers: [
  ...
  {
    id: 6,
    question: "당신은 길을 가다 정신을 잃은 생존자를 발견했습니다.",
    answers: [
  ...
  {
    id: 8,
    question: "당신을 붙잡은 불량배들로부터 제안을 받았습니다.",
    answers: [
  ...
  {
    id: 9,
    question: "당신은 시체가 즐비한 캠프를 살피던 중이었습니다.",
    answers: [
    ...
    <div>
      {showScore ? (
        ...
        <>
                ...
                <div key={id}>
                  <label>
                    <input
                      ...
                      value={answer}
                      onChange={() => handleAnswerSelect(question.id, answer, answer.isCorrect)}
                      checked={
          ...
          <h3>선택된 답변</h3>
          <ul>
            {Object.entries(result).map(([answer, count]) => (
              <li key={answer}>
                {answer}: {count}
              </li>
            ))}
